...
//timeline and legend
  ...
  time1.selectAll("text").data(dateArray.slice(0,56))
       ...
       .attr("fill", "white")
       .on("click",function(){
         d3.selectAll("circle").remove().transition().delay(1000).duration(2000).ease(d3.easeElasticOut)
         d3.selectAll("text#bubtext").remove().transition().delay(1000).duration(2000).ease(d3.easeElasticOut)
